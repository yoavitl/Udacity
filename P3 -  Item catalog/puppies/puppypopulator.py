...
#Add Shelters
shelter1 = Shelters(Sname = "Oakland Animal Services", address = "1101 29th Ave", city = "Oakland", state = "California", zipcode = "94601", website = "oaklandanimalservices.org")
session.add(shelter1)

shelter2 = Shelters(Sname = "San Francisco SPCA Mission Adoption Center", address="250 Florida St", city="San Francisco", state="California", zipcode = "94103", website = "sfspca.org")
session.add(shelter2)

shelter3 = Shelters(Sname = "Wonder Dog Rescue", address= "2926 16th Street", city = "San Francisco", state = "California" , zipcode = "94103", website = "http://wonderdogrescue.org")
session.add(shelter3)

shelter4 = Shelters(Sname = "Humane Society of Alameda", address = "PO Box 1571" ,city = "Alameda" ,state = "California", zipcode = "94501", website = "hsalameda.org")
session.add(shelter4)

shelter5 = Shelters(Sname = "Palo Alto Humane Society" ,address = "1149 Chestnut St." ,city = "Menlo Park", state = "California" ,zipcode = "94025", website = "paloaltohumane.org")
...
adopter1 = Adopter(name ="Jhon", familyName = "Stockton")
session.add(adopter1)

adopter2 = Adopter(name = "Hary", familyName = "Krishna")
session.add(adopter2)
session.commit()

print "imported al the puppies"
